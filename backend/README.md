...
## Project Structure
    ...
    ├── mithileshaassss_de_116455  # Django project configurations
...
1. Clone this repo and `cd mithileshaassss_de_116455`
...
2. Clone this repo and `cd mithileshaassss_de_116455`
